...
public interface ClientAccountDAO {
	...
	List<ClientAccount> loadMyAccounts(Integer userId) throws ServiceException;

	ClientAccount loadAccountByAccountNumber(String accountNumber) throws ServiceException;
