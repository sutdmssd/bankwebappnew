...
INSERT INTO `user` VALUES (1,'staff_1','jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=','APPROVED'),(2,'staff_2','jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=','APPROVED');
...
alter table client_account add column account_number varchar(45);
alter table client_transaction add column from_account_num varchar(45);